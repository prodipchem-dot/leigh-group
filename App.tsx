...
import { SCIENCE_DOMAINS, GROUP_STATS, MISSION_STATEMENT, PUBLICATIONS, Publication, GROUP_MEMBERS, SHANGHAI_MEMBERS, GroupMember, PROF_BIO, RESEARCH_PROJECTS, ResearchProject, HOME_ASSETS, RESEARCH_HIGHLIGHT_CONTENT, MONKEY_BUSINESS, Responsibility, MAP_THEME } from './constants';
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <div className="flex items-center space-x-6">
          ...
          <Link to="/" className="group flex flex-col">
            <h1 className="text-xl font-extrabold tracking-tight text-[#660099] group-hover:text-purple-700 transition-colors uppercase leading-none italic">Leigh group</h1>
...
const HomePage = () => {
  const content = {
    welcomeTitle: (
      <h2 className="text-3xl font-black text-slate-900 serif-font">
        Welcome to the <i className="italic">Leigh group</i> website
      </h2>
    ),
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start pt-4">
               <div className="space-y-4">
                  ...
                  <div className="bg-[#ffcc00] p-4 rounded-2xl shadow-md border-2 border-white max-w-[256px]">
                    <p className="text-[#660099] font-black text-[10px] uppercase tracking-tight leading-tight">INTERESTED IN JOINING THE <i className="italic">LEIGH GROUP</i>? <a href="https://www.catenane.net/pages/apply.html" target="_blank" className="underline ml-1">SEE HERE.</a></p>
                  </div>
               </div>
  ...
  return (
    <div className="pt-40 pb-32 px-6 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="bg-slate-200 p-4 md:p-10 rounded-[3rem] border border-slate-300 shadow-inner overflow-x-auto custom-scrollbar">
          <div className="min-w-[1018px] flex justify-center">
            ...
            >
              <defs>
                ...
                <style type="text/css">{`
                  .land { fill: ${theme.landDefault}; fill-opacity: 1; stroke: ${theme.border}; stroke-opacity: ${theme.borderOpacity}; stroke-width: 0.8; transition: fill 0.3s; filter: url(#land-glow); }
                  .land:hover { fill-opacity: 0.8; }
                  .group-link { cursor: pointer; }
                  .group-link text { font-size: 11px; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 800; fill: ${theme.text}; transition: fill 0.2s, font-size 0.2s; stroke: white; stroke-width: 0.4px; paint-order: stroke; }
                  .group-link:hover text { fill: ${theme.textHover}; font-size: 12px; text-decoration: underline; stroke: ${theme.accent}; stroke-width: 0.8px; }
                  .connector-line { fill: none; stroke: #000000; stroke-width: 1.2px; stroke-linecap: round; stroke-linejoin: round; stroke-opacity: 0.5; }
                `}</style>
              </defs>

              <g className="map-paths">
                {/* Asia & Pacific */}
                <path d="m 625.12,398.97 0.5,-0.15 0.11,0.84 2.19,-0.48 2.32,0.08 1.69,0.09 1.92,-2.07 2.1,-1.98 1.77,-1.9 0.53,1.05 0.38,2.44 -1.43,0.01 -0.23,2 0.5,0.42 -1.27,0.6 -0.01,1.25 -0.82,1.26 -0.07,1.21 -0.57,0.64 -8.42,-1.52 -1.08,-3.08 z" className="land" style={{fill: theme.asia}} />
                ...
                {/* Europe */}
                <path d="m 538.23,339.91 -0.35,1.27 0.4,1.59 1.16,0.9 -0.06,0.97 -0.91,0.54 -0.17,1.19 -1.3,1.76 -0.48,-0.25 -0.05,-0.8 -1.56,-1.23 -0.24,-1.75 0.24,-2.53 0.38,-1.16 -0.47,-0.59 -0.19,-1.19 1.22,-1.87 0.17,0.72 0.76,-0.34 0.6,1.02 0.67,0.38 z" className="land" style={{fill: theme.europe}} />
                <path d="m 602.7,342.75 3.9,-0.58 0.58,0.98 1.07,0.64 -0.57,0.92 1.5,1.26 -0.79,1.16 1.19,0.99 1.26,0.59 0.06,2.5 -1.02,0.1 -1.14,-2.08 0.01,-0.55 -1.24,0.01 -0.83,-0.98 -0.58,0.1 -1.11,-1.06 -2.08,-0.91 0.27,-1.79 z" className="land" style={{fill: theme.asia}} />
                ...
                {/* Additional Land Elements */}
                <path d="m 263.11,400.45 -0.69,0.15 -0.71,-1.76 -1.05,-0.89 0.61,-1.95 0.84,0.12 0.98,2.55 0.02,1.78 z" className="land" style={{fill: theme.americas}} />
                <path d="m 737.61,388.03 1.14,1 -0.2,1.93 -2.29,0.09 -2.36,-0.21 -1.77,0.49 -2.55,-1.19 -0.05,-0.63 1.85,-2.34 1.51,-0.8 2.01,0.73 1.48,0.08 z" className="land" style={{fill: theme.asia}} />
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-slate-200 pb-8">
             <div className="space-y-4">
                ...
                <p className="text-slate-500 max-w-2xl leading-relaxed font-medium">
                  The <i className="italic">Leigh Group</i> and their guests have use of a pair of Season Tickets for Manchester United. 
  ...
  <div className="pt-40 pb-32 bg-white">
    <div className="max-w-7xl mx-auto px-6 space-y-32">
      <section className="space-y-12 text-center">
        <div className="space-y-6">
          <h1 className="text-5xl md:text-8xl font-black text-slate-900 serif-font tracking-tight mb-4 uppercase">Research Frontiers</h1>
    ...
    <div className="pt-40 pb-32 px-6 bg-slate-50">
      <div className="max-w-6xl mx-auto space-y-16">
        <div className="text-center space-y-8">
          ...
          <div>
            <h1 className="text-5xl md:text-8xl font-black text-slate-900 serif-font tracking-tight mb-4 uppercase">Scientific Archive</h1>
        ...
        <div className="bg-white p-16 rounded-[3rem] text-center space-y-8 border border-purple-100 shadow-2xl relative overflow-hidden group">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto leading-relaxed text-lg">The <i className="italic">Leigh Group</i> has pioneered mechanical bonding, chemical topology, and artificial molecular motors for over three decades. This comprehensive list represents our commitment to scientific discovery at the nanoscale.</p>
          ...
          <div className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-slate-600 leading-relaxed">
                The <i className="italic">Leigh group</i> is housed in the <span className="font-bold text-slate-900">Sir Robert Robinson Laboratory</span>, a custom-designed state-of-the-art facility for advanced organic synthesis in the 21st century on the 4th Floor of the Chemistry Building.
              </p>
              <div className="space-y-4">
    ...
    <div className="pt-40 pb-32 px-6 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-16">
        <div className="text-center space-y-8">
          ...
          <div>
            <h1 className="text-5xl md:text-8xl font-black text-slate-900 serif-font tracking-tight mb-4 uppercase italic">Leigh Group Team</h1>
  ...
  <footer className="pt-12 pb-12 px-6 border-t border-slate-100 bg-white relative overflow-hidden">
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
        <div className="md:col-span-6 space-y-6">
          <div className="flex items-center space-x-4">
            ...
            <span className="text-lg font-bold tracking-tight text-[#660099] uppercase italic">Leigh Group</span>
          </div>
          <p className="text-slate-500 leading-relaxed text-sm max-w-sm">Pushing the boundaries of molecular machines and chemical topology at the University of Manchester.</p>
        </div>
      ...
      <div className="pt-10 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-8">
        <p className="text-xs text-slate-400 font-bold uppercase tracking-widest order-2 md:order-1">© {new Date().getFullYear()} The <i className="italic">Leigh Group</i>. University of Manchester.</p>

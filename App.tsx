          ...
          <div className="min-w-[1018px] flex justify-center">
            ...
            >
              ...
              <g className="map-paths">
                ...
                <path d="m 533.79,328.36 1.02,-0.01 -0.7,1.72 1.35,1.5 -0.41,1.82 -0.66,0.17 -0.53,0.36 -0.91,0.89 -0.41,2.1 -2.48,-1.44 -1.06,-1.61 -1.07,-0.85 -1.29,-1.45 -0.6,-1.21 -1.38,-1.83 0.59,-1.64 1.01,0.91 0.6,-0.82 1.31,-0.09 2.41,0.66 1.94,-0.06 z" className="land" style={{fill: '#f97316', stroke: '#9a3412', strokeOpacity: 0.5}} />
                ...
                <path d="m 489.8,301.16 2.05,0.35 2.6,-0.93 1.77,1.95 1.55,1.04 -0.32,2.97 -0.73,0.16 -0.31,2.43 -2.45,-1.97 -1.44,0.34 -1.96,-2.06 -1.3,-1.77 -1.3,-0.07 -0.41,-1.56 z" className="land" style={{fill: '#f97316', stroke: '#9a3412', strokeOpacity: 0.5}} />
                ...
                <path d="m 562.77,481.18 -0.18,-3.37 -0.71,-1.26 1.71,0.22 0.86,-1.59 1.49,0.18 0.16,1.1 0.6,0.63 0.03,0.91 -0.69,0.58 -1.1,1.46 -1.01,1.01 z" className="land" style={{fill: '#f43f5e', stroke: '#9f1239', strokeOpacity: 0.5}} />
                <path d="m 488.05,451.17 -2.32,0.33 -0.69,-1.94 0.13,-6.46 -0.57,-0.58 -0.1,-1.39 -0.98,-0.99 -0.85,-0.83 0.36,-1.5 0.96,-0.32 0.57,-1.24 1.37,-0.26 0.61,-0.86 0.94,-0.83 1.01,-0.01 2.14,1.64 -0.11,0.95 0.63,1.68 -0.55,1.14 0.29,0.76 -1.36,1.75 -0.86,0.87 -0.53,1.77 0.07,1.79 z" className="land" style={{fill: '#f43f5e', stroke: '#9f1239', strokeOpacity: 0.5}} />
                ...
                <path d="m 263.11,400.45 -0.69,0.15 -0.71,-1.76 -1.05,-0.89 0.61,-1.95 0.84,0.12 0.98,2.55 0.02,1.78 z" className="land" style={{fill: '#3b82f6', stroke: '#1e3a8a', strokeOpacity: 0.5}} />
                <path d="m 737.61,388.03 1.14,1 -0.2,1.93 -2.29,0.09 -2.36,-0.21 -1.77,0.49 -2.55,-1.19 -0.05,-0.63 1.85,-2.34 1.51,-0.8 2.01,0.73 1.48,0.08 z" className="land" style={{fill: '#8b5cf6', stroke: '#4c1d95', strokeOpacity: 0.5}} />

...
export const MAP_THEME = {
  ...
  landDefault: '#94a3b8',
  europe: '#8b5cf6',
  americas: '#0284c7', // More saturated blue for visibility
  asia: '#f59e0b',
  africa: '#f43f5e',
  southAmerica: '#10b981',
  text: '#4c0071',
...
export const HOME_ASSETS = {
  ...
  footerCards: [
    ...
    { title: "World of Molecular Machines", subtitle: "RESEARCHER MAP", image: "images/general/chemmap_thumb.jpg", link: "/supramolecular-world" }
  ],
  quotes: [
